...
impl AddressService {
    pub async fn create(
        ...
        sqlx::query_as::<_, Address>(
            r#"INSERT INTO addresses (id, user_id, address, label, phone_number, main)
        ...
        .bind(data.main.unwrap_or(false))
        .fetch_one(db)
        .await
    ...
    pub async fn update(
        ...
        sqlx::query_as::<_, Address>(
            r#"UPDATE addresses SET
               address = $2, label = $3, phone_number = $4, main = $5, updated_at = NOW()
