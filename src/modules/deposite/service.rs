...
impl DepositeService {
    pub async fn create(db: &PgPool, user_id: Uuid, data: CreateDepositeRequest) -> AppResult<Deposite> {
        let id = Uuid::new_v4();
    ...
    pub async fn get_by_user(db: &PgPool, user_id: Option<Uuid>, limit: i64) -> AppResult<Vec<Deposite>> {
